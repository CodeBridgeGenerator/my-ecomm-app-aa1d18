...
<Column field="category" header="Category" body={pTemplate3} filter={selectedFilterFields.includes("category")} hidden={selectedHideFields?.includes("category")}  sortable style={{ minWidth: "8rem" }} />
